...
# summary statistics for condition D
print('Summary Stats Condition D OS Cost', simulation.get_sumStat_con_d_OS_cost().get_mean())
print('Summary Stats Condition D NoOS Cost', simulation.get_sumStat_con_d_NoOS_cost().get_mean())
print('Summary Stats Condition D OS Utilities', simulation.get_sumStat_con_d_OS_utilities().get_mean())
print('Summary Stats Condition D NoOS Utilities', simulation.get_sumStat_con_d_NoOS_utilities().get_mean())
print (" ")
